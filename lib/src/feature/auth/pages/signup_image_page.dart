...
import 'package:multisol/src/feature/auth/controllers/signup_image_page_controller.dart';

import '../../../utils/custom_color.dart';
import '../../../widgets/full_size_loading_indicator.dart';
import '../../../widgets/main_button.dart';

class SignupImagePage extends GetView<SignupImagePageController> {
  const SignupImagePage({super.key});
  ...
  Widget build(BuildContext context) {
    Get.put(SignupImagePageController());
    return Stack(
      children: [
        Scaffold(
